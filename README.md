...
- **[agent-safety](./skills/engineering/agent-safety/SKILL.md)**: Install cross-harness guardrails that block dangerous agent shell commands (git push/reset/clean, curl\|bash) in Cursor Grok, Claude Code, and via AGENTS.md for Codex.
