...
- On a codebase you have never worked in, [onboarding-audit](https://aihero.dev/skills-onboarding-audit) maps it first.
- To carry out a restructure it identified, use [clean-architecture](https://aihero.dev/skills-clean-architecture).
