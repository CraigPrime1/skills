...
- **Standalones**, off every flow, reached for on their own terms: the prototype, the questionnaire, the merge conflict you are already sitting in, a reusable [UI component](https://aihero.dev/skills-ui-components), or a high-stakes change run through [four-hats](https://aihero.dev/skills-four-hats).
