...
| A failure in a deployed environment you cannot reproduce locally | [production-debugging](https://aihero.dev/skills-production-debugging) first: it hands back here the moment the bug reproduces |
