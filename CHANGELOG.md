...
- [`8d9759e`](https://github.com/mattpocock/skills/commit/8d9759e918c5a98040adb904db87c2ff5ca917d4) - Add eight model-invoked engineering skills covering the senior-engineer work the set didn't have a home for.

  - **`system-design`** — design a scalable system (requirements as numbers, access patterns → schema, API contract, data flow, caching where invalidation _is_ the design, failure modes), then build one vertical slice of it for real. Numbers before boxes: every component must trace to a figure.
